...
app = modal.App("transcription-orchestrator-reazon-v1")
web_app = FastAPI()
...
async def process_audio_background(
    ...
    try:
        ASRService = modal.Cls.from_name("transcription-reazon-k2-v1", "ReazonK2ASRService")
        ...
        transcript = build_transcript_from_asr_results(
            asr_results,
            speaker_segments,
        )
...
def build_transcript_from_asr_results(asr_results, speaker_segments):
    transcript = []
